...
CollectionReference users1 = firestore.collection('nama');
    ...
    if (_validateAndSave()) {
      ...
      if (_formMode == FormMode.LOGIN) {
        ...
        try {
          ...
          users1.doc(uid).get().then((value) =>
              (userCredential.user.updateProfile(displayName: value['nama'])));
        ...
        try {
          ...
          userId = userCredential.user.uid;
          users1.doc(userId).set({'nama': '$_Displayname'});
